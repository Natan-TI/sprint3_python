...
while True:
    ...
    if opcao == 1:
        ...
        opcao_fav = add_fav(onibus, usuario, opcoes_fav)
        print(f"Ônibus {onibus['número'][opcao_fav]} - {onibus['nome'][opcao_fav]} adicionado com sucesso!")
    elif opcao == 4:
        verificar_fav(onibus, usuario)
    else:
